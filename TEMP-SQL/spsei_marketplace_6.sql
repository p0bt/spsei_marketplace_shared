...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Úte 06. pro 2022, 16:54
...
(18, 74, NULL, NULL, '2022-12-06 18:27:00', '2022-12-07 19:27:00');
...
(73, 19, 10, NULL, 'Mám v něm všechny zápisy', 58, 'offer_u19_638f5f2f600ba', '2022-12-06 16:26:39'),
(74, 19, 11, NULL, 'hezký stav', NULL, 'offer_u19_638f5f7a381ea', '2022-12-06 16:27:54');
...
(19, 'Janaaas', 'Nováková', 9, 'test@test.cz', '$2y$10$M./BL.2apvUSH2u71N5Yce0W828hBN05bu.rZkAzHujI.733oIHdO', '::1', 1, '2022-12-06 16:43:19', '2022-02-27 15:13:04'),
...
--
ALTER TABLE `notebooks`
  MODIFY `notebook_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
