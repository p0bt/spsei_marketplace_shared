...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Čtv 03. lis 2022, 23:02
...
INSERT INTO `books` (`book_ISBN`, `name`, `author`, `category_id`) VALUES
('1', 'Matematika I', 'Jiřina Petáková', 2),
('2', 'Literatura v kostce I', 'Marie Sochrová', 2),
('978-80-251-49', 'Programovací jazyk C', 'Brian W. Kernighan, Dennis M. Ritchie', 1);
