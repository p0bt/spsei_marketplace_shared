...
class Chat extends BaseModel
{
    ...
    {
        return $this->db->query("INSERT INTO `chats` 
                                (`chat_id`, `user_id`)
                                VALUES (?, ?)", 
    ...
    {
        return $this->db->query("SELECT c.chat_id AS 'chat_id', u.user_id AS 'user_id', u.first_name AS 'first_name', u.last_name AS 'last_name', u.email AS 'email', m.text AS 'last_text', m.date_sent AS 'date_sent'
                                FROM chats c
