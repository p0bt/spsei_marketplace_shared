...
class OfferController extends BaseController
{
    ...
    public function offers()
    {
        ...
        $data['offers'] = $this->offers_model->get_all();
    ...
    public function post_offer()
    {
        if ($_POST)
        {
            $this->validator->addMultipleRules([
                'category' => 'required|in_list[ucebnice, sesit]',
            ...
            if ($this->validator->run())
            {
                ...
                switch($_POST['category']) 
                {
                    case 'ucebnice':
                        $this->validator->addMultipleRules([
                            'name' => 'required|is_not_unique[books.book_id]',
                        ]);
                        break;
                    case 'sesit':
                        $this->validator->addMultipleRules([
                ...
                if ($this->validator->run()) 
                {
                    $post_data = [
                        ...
                        'book_id' => (intval($_POST['name']) != 0) ? $_POST['name'] : null,
