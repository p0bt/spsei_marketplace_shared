                        ...
                        <div class="row py-1">
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="category" id="category-radio-ucebnice" value="ucebnice" checked required>
                                    <label class="form-check-label" for="category-radio-ucebnice">
                                        <div>Učebnici / Pracovní sešit</div>
                                        <img src="/assets/images/book_icon.png" alt="Učebnice / Pracovní sešit" width="100" class="mt-1">
                                    </label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="category" id="category-radio-sesit" value="sesit">
                                    <label class="form-check-label" for="category-radio-sesit">
                                        <div>Sešit (Poznámky)</div>
                                        <img src="/assets/images/notebook_icon.png" alt="Sešit (Poznámky)" width="100" class="mt-1">
                                    </label>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function render_name_form(val) {
            ...
            switch (val) {
                case 'ucebnice':
                    form = `<select name="name" class="form-select" required>
                                <option value="none" selected>--- Vyberte ---</option>
                                <?php foreach ($books as $book) : ?>
                                    <option value="<?= $book['book_id'] ?>" <?= (HelperFunctions::setInputValue("name") == $book['book_id']) ? "selected" : "" ?>><?= $book['name'] ?> (<?= $book['author'] ?>)</option>
                                <?php endforeach; ?>
                            </select>`;
                    break;
                case 'sesit':
